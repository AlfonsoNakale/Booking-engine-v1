var $5TXzU$flatpickr = require("flatpickr");
...
function $3b8482e534b8b250$export$de01a5d2298a9bfb() {
    ...
    pickupDateInstance = (0, ($parcel$interopDefault($5TXzU$flatpickr)))("#i-pickup-date", pickupDateConfig);
    returnDateInstance = (0, ($parcel$interopDefault($5TXzU$flatpickr)))("#i-return-date", returnDateConfig);
    ...
    (0, ($parcel$interopDefault($5TXzU$flatpickr)))("#i-date-of-birth", dobConfig);
    (0, ($parcel$interopDefault($5TXzU$flatpickr)))("#i-expiration-date", expirationConfig);
