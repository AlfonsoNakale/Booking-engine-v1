      ...
      function (require, module, exports) {
        ...
        window.Webflow.push(() => {
          ...
          const showError = (message) => {
            ...
            if (errorAlert) {
              errorAlert.querySelector(".error-alert-text").textContent =
                message;
          ...
          const showSuccess = (message) => {
            ...
            if (successAlert) {
              successAlert.querySelector(".success-alert-text").textContent =
                message;
    ...
    "5WDZW": [
      function (require, module, exports) {
          ...
          document.querySelectorAll('[id^="v-calc-"]').forEach((element) => {
            ...
            if (!isNaN(originalPrice)) {
              ...
              if (element.id === "v-calc-vehicle-price") {
                const convertedPrice = (originalPrice * rate).toFixed(
                  config.decimals
                );
         ...
         */ function calculateTotalExtras(rate, decimals) {
          const totalExtrasElement = document.querySelector(
            "#v-calc-total-extra"
          );
          if (!totalExtrasElement) return;
          let totalExtras = 0;
          document
            .querySelectorAll('[id^="v-calc-extra-"]')
            .forEach((extraElement) => {
         ...
         */ function calculateFinalTotals(rate, decimals) {
          ...
          const subtotalNAD =
            vehiclePrice * duration + deliveryFee + totalExtras;
          const taxNAD = subtotalNAD * 0.15; // 15% tax rate
          const totalNAD = subtotalNAD + taxNAD;
          // Convert and display
          if (elements.subtotal) {
            elements.subtotal.textContent = (subtotalNAD * rate).toFixed(
              decimals
            );
    ...
    cpLd6: [
      function (require, module, exports) {
        ...
        function initializePickupLocation() {
          // Get DOM elements
          const pickupConfirmation = document.querySelector(
            "#pickup-confirmation"
          );
          ...
          pickupConfirmation.addEventListener("change", function () {
            ...
            pickupLocation.closest(".input-dropdown").style.display =
              displayStyle;
            returnLocation.closest(".input-dropdown").style.display =
              displayStyle;
        ...
        function initializeDatePickers() {
          ...
          pickupDateInstance = (0, _flatpickrDefault.default)(
            "#i-pickup-date",
            pickupDateConfig
          );
          returnDateInstance = (0, _flatpickrDefault.default)(
            "#i-return-date",
            returnDateConfig
          );
      ...
      function (require, module, exports) {
        ...
        function FlatpickrInstance(element, instanceConfig) {
          ...
          function updateTime(e) {
            if (self.selectedDates.length === 0) {
              var defaultDate =
                ...
                (0, _dates.compareDates)(new Date(), self.config.minDate) >= 0
                  ? new Date()
          ...
          function ampm2military(hour, amPM) {
            return (
              (hour % 12) + 12 * (0, _utils.int)(amPM === self.l10n.amPM[1])
            );
          }
          ...
          function setHours(hours, minutes, seconds) {
            ...
            if (!self.hourElement || !self.minuteElement || self.isMobile)
              return;
            self.hourElement.value = (0, _utils.pad)(
              !self.config.time_24hr
                ? ((12 + hours) % 12) + 12 * (0, _utils.int)(hours % 12 === 0)
                : hours
            );
            self.minuteElement.value = (0, _utils.pad)(minutes);
            if (self.amPM !== undefined)
              self.amPM.textContent =
                self.l10n.amPM[(0, _utils.int)(hours >= 12)];
            if (self.secondElement !== undefined)
              self.secondElement.value = (0, _utils.pad)(seconds);
          }
          ...
          function bindEvents() {
            ...
            self._debouncedChange = (0, _utils.debounce)(
              triggerChange,
              DEBOUNCED_CHANGE_MS
            );
            if (
              ...
              bind(self.daysContainer, "mouseover", function (e) {
                if (self.config.mode === "range")
                  onMouseOver((0, _dom.getEventTarget)(e));
              });
          ...
          function build() {
            ...
            self.calendarContainer = (0, _dom.createElement)(
              "div",
              "flatpickr-calendar"
            );
            ...
            if (!self.config.noCalendar) {
              ...
              self.innerContainer = (0, _dom.createElement)(
                "div",
              ...
              self.rContainer = (0, _dom.createElement)(
                "div",
                "flatpickr-rContainer"
              );
              self.rContainer.appendChild(buildWeekdays());
              if (!self.daysContainer) {
                self.daysContainer = (0, _dom.createElement)(
                  "div",
                  "flatpickr-days"
                );
            ...
            if (self.config.inline || self.config.static) {
              ...
              if (self.config.static) {
                var wrapper = (0, _dom.createElement)(
                  "div",
                  "flatpickr-wrapper"
                );
          ...
          function createDay(className, date, _dayNumber, i) {
            var dateIsEnabled = isEnabled(date, true),
              dayElement = (0, _dom.createElement)(
                "span",
                className,
            ...
            if (
              ...
              (0, _dates.compareDates)(date, self.now) === 0
            ) {
          ...
          function buildMonthSwitch() {
            ...
            for (var i = 0; i < 12; i++) {
              ...
              var month = (0, _dom.createElement)(
                "option",
                "flatpickr-monthDropdown-month"
              );
              month.value = new Date(self.currentYear, i).getMonth().toString();
              month.textContent = (0, _formatting.monthToStr)(
                i,
          ...
          function buildMonth() {
            ...
            if (
              ...
              self.monthsDropdownContainer = (0, _dom.createElement)(
                "select",
            ...
            var currentMonth = (0, _dom.createElement)(
              "div",
          ...
          function buildMonthNav() {
            ...
            self.yearElements = [];
            self.monthElements = [];
            self.prevMonthNav = (0, _dom.createElement)(
              "span",
              "flatpickr-prev-month"
            );
            self.prevMonthNav.innerHTML = self.config.prevArrow;
            self.nextMonthNav = (0, _dom.createElement)(
              "span",
          ...
          function buildTime() {
            ...
            var defaults = (0, _dates.getDefaultHours)(self.config);
            self.timeContainer = (0, _dom.createElement)(
              "div",
              "flatpickr-time"
            );
            self.timeContainer.tabIndex = -1;
            var separator = (0, _dom.createElement)(
              "span",
            ...
            self.minuteElement.value = (0, _utils.pad)(
              self.latestSelectedDateObj
            ...
            if (self.config.enableSeconds) {
              ...
              self.secondElement.value = (0, _utils.pad)(
                self.latestSelectedDateObj
              ...
              self.timeContainer.appendChild(
                (0, _dom.createElement)("span", "flatpickr-time-separator", ":")
              );
              self.timeContainer.appendChild(secondInput);
            }
            if (!self.config.time_24hr) {
              self.amPM = (0, _dom.createElement)(
                "span",
                "flatpickr-am-pm",
                self.l10n.amPM[
                  (0, _utils.int)(
          ...
          function buildWeekdays() {
            if (!self.weekdayContainer)
              self.weekdayContainer = (0, _dom.createElement)(
                "div",
                "flatpickr-weekdays"
              );
            else (0, _dom.clearNode)(self.weekdayContainer);
            for (var i = self.config.showMonths; i--; ) {
              var container = (0, _dom.createElement)(
                "div",
          ...
          function buildWeeks() {
            ...
            var weekWrapper = (0, _dom.createElement)(
              "div",
            ...
            hoverableCells.forEach(function (dayElem) {
              ...
              if (elem !== undefined) {
                ...
                if (
                  timestamp >= minRange &&
                  (maxRange === 0 || timestamp <= maxRange) &&
                  (0, _dates.isBetween)(timestamp, initialDate, hoverDate)
                )
          ...
          function parseConfig() {
            ...
            if (!userConfig.dateFormat && (userConfig.enableTime || timeMode)) {
              var defaultDateFormat =
                ...
                (0, _options.defaults).dateFormat;
              formats.dateFormat =
            ...
            (0, _options.HOOKS)
              ...
              .forEach(function (hook) {
                self.config[hook] = (0, _utils.arrayify)(
                  self.config[hook] || []
                ).map(bindToInstance);
              });
            self.isMobile =
            ...
            for (var i = 0; i < self.config.plugins.length; i++) {
              ...
              for (var key in pluginConf) {
                if ((0, _options.HOOKS).indexOf(key) > -1)
                  self.config[key] = (0, _utils.arrayify)(pluginConf[key])
                    .map(bindToInstance)
          ...
          function setupLocale() {
            ...
            (0, _formatting.tokenRegex).D =
              "(" + self.l10n.weekdays.shorthand.join("|") + ")";
            (0, _formatting.tokenRegex).l =
              "(" + self.l10n.weekdays.longhand.join("|") + ")";
            (0, _formatting.tokenRegex).M =
              "(" + self.l10n.months.shorthand.join("|") + ")";
            (0, _formatting.tokenRegex).F =
              "(" + self.l10n.months.longhand.join("|") + ")";
            (0, _formatting.tokenRegex).K =
              "(" +
              self.l10n.amPM[0] +
              "|" +
              self.l10n.amPM[1] +
          ...
          function selectDate(e) {
            ...
            var t = (0, _dom.findParent)(
              (0, _dom.getEventTarget)(e),
              isSelectable
            );
          ...
          function set(option, value) {
            if (option !== null && typeof option === "object") {
              ...
              else if ((0, _options.HOOKS).indexOf(option) > -1)
                self.config[option] = (0, _utils.arrayify)(value);
            }
            self.redraw();
            updateValue(true);
          }
          ...
          function setupInputs() {
            ...
            if (self.config.altInput) {
              self.altInput = (0, _dom.createElement)(
                self.input.nodeName,
                self.config.altInputClass
              );
          ...
          function setupMobile() {
            var inputType = self.config.enableTime
              ? self.config.noCalendar
                ...
                : "datetime-local"
              : "date";
            self.mobileInput = (0, _dom.createElement)(
              "input",
          ...
          function isDateSelected(date) {
            for (var i = 0; i < self.selectedDates.length; i++) {
              ...
              if (
                ...
                (0, _dates.compareDates)(selectedDate, date) === 0
              )
                return "" + i;
            }
            return false;
          ...
          function isDateInRange(date) {
            if (self.config.mode !== "range" || self.selectedDates.length < 2)
              return false;
            return (
              (0, _dates.compareDates)(date, self.selectedDates[0]) >= 0 &&
              (0, _dates.compareDates)(date, self.selectedDates[1]) <= 0
            );
          }
          ...
          function timeWrapper(e) {
            ...
            if (self.amPM !== undefined && eventTarget === self.amPM)
              self.amPM.textContent =
                self.l10n.amPM[
                  (0, _utils.int)(self.amPM.textContent === self.l10n.amPM[0])
                ];
            ...
            if (
              ...
              if (newValue < min) {
                newValue =
                  max +
                  newValue +
                  (0, _utils.int)(!isHourElem) +
                  ((0, _utils.int)(isHourElem) && (0, _utils.int)(!self.amPM));
                if (isMinuteElem)
                  incrementNumInput(undefined, -1, self.hourElement);
              } else if (newValue > max) {
                newValue =
                  input === self.hourElement
                    ? newValue - max - (0, _utils.int)(!self.amPM)
                    : min;
                if (isMinuteElem)
                  incrementNumInput(undefined, 1, self.hourElement);
              }
    ...
    hioKU: [
      function (require, module, exports) {
        ...
        var createDateFormatter = function (_a) {
          var _b = _a.config,
            config = _b === void 0 ? (0, _options.defaults) : _b,
            _c = _a.l10n,
            l10n = _c === void 0 ? (0, _default.english) : _c,
            _d = _a.isMobile,
          ...
          return function (dateObj, frmt, overrideLocale) {
            ...
            return frmt
              ...
              .map(function (c, i, arr) {
                return (0, _formatting.formats)[c] && arr[i - 1] !== "\\"
                  ? (0, _formatting.formats)[c](dateObj, locale, config)
                  : c !== "\\"
                  ? c
                  : "";
              })
        ...
        var createDateParser = function (_a) {
          ...
          return function (date, givenFormat, timeless, customLocale) {
            ...
            if (date instanceof Date) parsedDate = new Date(date.getTime());
              ...
              var format =
                givenFormat || (config || (0, _options.defaults)).dateFormat;
      ...
      function (require, module, exports) {
        ...
        var revFormat = {
          ...
          K: function (dateObj, amPM, locale) {
            dateObj.setHours(
              (dateObj.getHours() % 12) +
                12 * (0, _utils.int)(new RegExp(locale.amPM[1], "i").test(amPM))
            );
          },
        ...
        const initializeVehicleSelection = () => {
          ...
          vehicleInputs.forEach((input) => {
            input.addEventListener("change", (e) => {
              ...
              document.querySelector("#v-vehicle-name").textContent =
                vehicleName;
      ...
      function (require, module, exports) {
        ...
        const EXTRAS = [
          ...
          },
          {
            ...
            perDay: true,
            displayName:
              "Bedding (incl. 1x sleeping bag + 1x pillow) @ 20.00 p.d",
          },
          {
            id: 10,
            name: "GPS-System",
        ...
        const updateExtraCalculation = (extraId) => {
          ...
          const duration =
            parseInt(document.querySelector("#v-calc-duration")?.textContent) ||
            0;
